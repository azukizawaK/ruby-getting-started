...
class IdolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create idol" do
    assert_difference('Idol.count') do
      post idols_url, params: { idol: { name: @idol.name, photo: @idol.photo, profile: @idol.profile } }
    end
  ...
  test "should update idol" do
    patch idol_url(@idol), params: { idol: { name: @idol.name, photo: @idol.photo, profile: @idol.profile } }
